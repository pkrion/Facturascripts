...
class __TwigTemplate_ee6070f26610bfd6dd3b47e2507250c2 extends Template
{
    private $source;
    private $macros = [];
...
<script>
    ...
    {
        return new Source("<div id=\"messages-toasts\" style=\"z-index: 9999; position: fixed; bottom: 0; left: 50%; transform: translateX(-50%);\"></div>
...
<script>
    function setToast(message, style = 'info', title = '', time = 10000) {
        ...
        let html = '<div class=\"toast toast-' + style + ' ' + styleBorder + '\" style=\"margin: 15px auto 0 auto;\" role=\"' + role + '\" aria-live=\"' + live + '\" aria-atomic=\"true\" ' + delay + '>'
            + '<div class=\"toast-header ' + styleHeader + '\">'
            + '<strong class=\"mr-auto\">' + icon + title + '</strong>'
            + '<button type=\"button\" class=\"ml-4 btn close ' + styleHeader + '\" data-dismiss=\"toast\" aria-label=\"{{ trans('close') }}\">'
            + '<span aria-hidden=\"true\">&times;</span>'
            + '</button>'
            + '</div>';
...
</script>", "Macro/Toasts.html.twig", "D:\\xampp\\htdocs\\Facturascripts\\Plugins\\MartosOS\\View\\Macro\\Toasts.html.twig");
    }
}
